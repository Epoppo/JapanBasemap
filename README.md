...
<br>
    ...
    <img src="https://raw.githubusercontent.com/Epoppo/JapanBasemap/images/images/v2_0_0/01_01_01_target_area.png" width=600)><br>
    <br>
    2. 日本における平面直角座標系01系~19系のいずれかの座標系、及び必要となる地図情報レベルを選択し、生成範囲となるベクタを設定して「実行」を押下 <br>
    <img src="https://raw.githubusercontent.com/Epoppo/JapanBasemap/images/images/v2_0_0/01_02_01_plugin_window_basemap.png" width=600)><br>
    <br>
    3. 設定したベクタに交差する図郭が出力されるので、スタイルを弄って完成<br>
    以下サンプル<br>
    地図情報レベル1000の生成<br>
    <img src="https://raw.githubusercontent.com/Epoppo/JapanBasemap/images/images/v2_0_0/01_03_01_basemapsample_base1000.png" width=600)><br>
    地図情報レベル5000,1000,500の生成テスト<br>
    <img src="https://raw.githubusercontent.com/Epoppo/JapanBasemap/images/images/v2_0_0/01_03_02_basemapsample.png" width=600)><br>
    <br><br>
    -- 地域メッシュが必要な場合 --<br>
    1. 「地域メッシュ生成」をダブルクリック<br>
    (国土基本図図郭の際とは投影系が異なるため、引き伸ばされたように見えますが同じベクタを用いております。)<br>
    <img src="https://raw.githubusercontent.com/Epoppo/JapanBasemap/images/images/v2_0_0/02_01_01_target_area.png" width=600)><br>
    <br>
    2. 世界測地系と日本測地系で必要な座標系、及び必要なメッシュ種別を選択し、生成範囲となるベクタを設定して「実行」を押下 <br>
    <img src="https://raw.githubusercontent.com/Epoppo/JapanBasemap/images/images/v2_0_0/02_02_01__plugin_window_regional.png" width=600)><br>
    <br>
    3. 設定したベクタに交差するメッシュが出力されるので、スタイルを弄って完成<br>
    以下サンプル<br>
    3次メッシュの生成<br>
    <img src="https://raw.githubusercontent.com/Epoppo/JapanBasemap/images/images/v2_0_0/02_03_01_meshsample_3rdmesh.png" width=600)><br>
    2次~6次メッシュの生成テスト<br>
    <img src="https://raw.githubusercontent.com/Epoppo/JapanBasemap/images/images/v2_0_0/02_03_02_meshsample_2nd_6thmesh.png" width=600)><br>
    100mメッシュの生成テスト<br>
    <img src="https://raw.githubusercontent.com/Epoppo/JapanBasemap/images/images/v2_0_0/02_03_03_100m_mesh.png" width=600)><br>
    <br><br>
...
| 標準地域メッシュ|JIS規格上の名称|別称|緯度の間隔|経度の感覚|一辺の長さ|名称桁数|名称<br>(例)| 作成方法 |
|:---|:---|:---|:---|:---|:---|:---|:---|:---|
|-|第1次地域区画|1次メッシュ|40 [分]|1 [度]|約 80 [km]|4桁|5339|緯度*1.5を上2桁、経度%100を下2桁とする。
|-|第2次地域区画|2次メッシュ |5 [分]|7.5 [分]|約 10 [km]|6桁|533903|1次メッシュを縦横8等分し、各区画に南と西から順に0~7の番号を振って縦の番号を5桁目、横の番号を6桁目とする
|統合地域メッシュ|5倍地域メッシュ |5kmメッシュ|2.5 [分]|3.75[分]|約 5 [km]|7桁|5339034|2次メッシュを縦横4等分し、南西を1、南東を2、北西を3、北東を4とする数値を7桁目とする。
|統合地域メッシュ|2倍地域メッシュ |2kmメッシュ|1 [分]|1.5 [分]|約 2 [km]|9桁|533903665|2次メッシュを縦横5等分し、各区画に南と西から順に0,2,4,6,8の番号を振って縦の番号を7桁目、横の番号を8桁目とし、5を9桁目とする。
|基準地域メッシュ|第3次地域区画|3次メッシュ|30 [秒]|45 [秒]|約 1 [km]|8桁|53390387|2次メッシュを縦横10等分し、各区画に南と西から順に0~9の番号を振って縦の番号を7桁目、横の番号を8桁目とする
|分割地域メッシュ|2分の1地域メッシュ |4次メッシュ|15 [秒]|22.5 [秒]|約 500 [m]|9桁|53393874|3次メッシュを縦横4等分し、南西を1、南東を2、北西を3、北東を4とする数値を9桁目とする。
|分割地域メッシュ|4分の1地域メッシュ |5次メッシュ|7.5 [秒]|11.25 [秒]|約 250 [m]|10桁|533938742|4次メッシュを縦横4等分し、南西を1、南東を2、北西を3、北東を4とする数値を10桁目とする。
|分割地域メッシュ|8分の1地域メッシュ |6次メッシュ|3.75 [秒]|5.625 [秒]|約 125 [m]|11桁|5339387423|5次メッシュを縦横4等分し、南西を1、南東を2、北西を3、北東を4とする数値を11桁目とする。
|-|-|3次メッシュ1/10細分区画<br>(100mメッシュ)|3 [秒]|4.5 [秒]|約 100 [m]|10桁|5339038757|3次メッシュを縦横10等分し、各区画に南と西から順に0~9の番号を振って縦の番号を9桁目、横の番号を10桁目とする
